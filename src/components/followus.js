...
const Followus = (props) => {
  ...
  return (
    <section className={`FollowUsWrap  ${props.bg}`}>
      ...
      />
      <div className="top w-full sm:flex flex-row-reverse sm:p-10 md:p-20 lg:p-30 xl:px-60 2xl:72 justify-between ">
        ...
        <div className="text -mt-10 ml-8 pb-10 sm:-mt-0 sm:ml-0 sm:p-20">
          <p className={`ginto ${props.bg==='bg-orange'?'text-skin':`text-orange`} text-3xl xsm:text-5xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl`}>
