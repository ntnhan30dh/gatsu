...
import killer_pic_mobile from "../images/killer_pic_mobile.png"
    ...
    <section className="storyContainer">
      ...
      <div className="DevourContainer relative bg-skin p-8 md:p-16 lg:px-40 2xl:px-60 md:flex ">
        ...
        <div className="headline ">
          <h1 className="ginto leading-90	 text-blue  text-14vw  md:text-7vw lg:text-7xl xl:text-7vw 2xl:text-9xl pr-20 xsm:pr-40 md:pr-60">READY <br /> STEADY <br /> DEVOUR</h1>
      ...
      {/* <div className=" hidden md:block w-48 lg:w-52 absolute -top-40 right-1/5 z-20 transform rotate-25">
        ...
        <div className="headlineDiv flex justify-between md:w-2/3	">
          ...
          <div className="text  md:mr-20  m-auto lg:mr-0 xl:mr-auto">
            <h1 className="ginto leading-90	   text-14vw md:text-7vw	 text-right text-skin  //text-4xl //xsm:text-6xl  lg:text-7xl xl:text-7vw 2xl:text-9xl  -ml-10 md:ml-0">
        ...
        <div className=" w-full my-6 md:w-1/2 lg:w-1/3 relative">
          <img className= " hidden md:block  w-full" src={killer_pic} alt="pic" />
            <img className=" md:hidden " src={killer_pic_mobile} alt="dish" />
